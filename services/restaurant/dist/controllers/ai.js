import { callGemini, callOpenAI, createFallbackDescription, extractJson, fallbackSellerInsight, fallbackSmartSearch, generateWithGemini, generateWithOpenAI, normalizeSmartSearch, trimField, } from "../utils/ai.js";
...
export const smartFoodSearch = async (req, res) => {
...
export const sellerPerformanceInsight = async (req, res) => {
