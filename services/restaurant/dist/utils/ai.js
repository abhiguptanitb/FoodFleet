...
export const trimField = (value, maxLength = 180) => {
...
export const callGemini = async (prompt, { maxOutputTokens = 240, temperature = 0.4 } = {}) => {
...
export const callOpenAI = async (instructions, input, { maxOutputTokens = 240 } = {}) => {
...
export const generateWithGemini = async (context) => {
...
export const generateWithOpenAI = async (context) => {
...
export const normalizeSmartSearch = (raw, query) => {
