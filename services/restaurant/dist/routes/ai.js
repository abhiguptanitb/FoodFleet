...
const generateWithOpenAI = async (context) => {
    ...
    const { data } = await axios.post("https://api.openai.com/v1/responses", {
        ...
        instructions: "You write concise, appetizing FoodFleet seller descriptions. Return only one polished description, no quotes, no labels, under 45 words. Avoid unsupported health claims.",
