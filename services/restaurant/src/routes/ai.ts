...
type SmartFoodSearchRequest = {
  query?: string;
};

type SellerInsightRequest = {
...
const normalizeSmartSearch = (raw: any, query: string) => {
...
const fallbackSmartSearch = (query: string) => {
...
const fallbackSellerInsight = (body: SellerInsightRequest) => {
...
router.post(
  "/smart-food-search",
  isAuth,
  async (req: Request<unknown, unknown, SmartFoodSearchRequest>, res: Response) => {
