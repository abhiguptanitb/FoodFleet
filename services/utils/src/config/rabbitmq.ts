...
const REQUIRED_ENV_VARS = ["RABBITMQ_URL", "PAYMENT_QUEUE"] as const;
...
export const connectRabbitMQ = async () => {
  ...
  throw new Error(
    "Utils service could not connect to RabbitMQ. Make sure RabbitMQ is running and RABBITMQ_URL points to it."
  );
};
